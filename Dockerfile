...
# Strip Windows CRLF if present (otherwise exec fails with "no such file or directory"
# because the kernel looks for "/bin/sh\r"). Invoke via /bin/sh so the shebang is unused.
